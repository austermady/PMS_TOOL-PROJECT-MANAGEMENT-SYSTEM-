    ...
    <div>
      ...
      ?>
        ...
        <div>
          ...
          <body>
            <table class="glass" width="100%" border="0" cellspacing="00" cellpadding="00">
              <tr>
                <th width="74" scope="col">&nbsp;</th>
                <th width="164" scope="col"><a href="../Admin.php"><img src="../logo1.png" alt="LOGO" /></a></th>
                <th width="646" scope="col">
                  <font size="8" color="White">Project Managenent System</font>
                </th>
            ...
            <table class="glass" width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <th width="15%" scope="col"><a href="report.php">Reports</a></th>
            ...
            <form method="post" action="meeting.php">
              <div class="glass" style="background-color:transparent; border:1px solid black; width:40%; margin-left:30%; margin-top:50px;">
                <table width="100%" border="0" cellspacing="05" cellpadding="05">
                  <tr>
                    <th width="14%" rowspan="2" scope="col">&nbsp;</th>
                    <th colspan="2" scope="col">
                      <font size="6">MEETING DETAIL</font>
                    </th>
                    <th width="12%" rowspan="2" scope="col">&nbsp;</th>
                  </tr>
                  <tr>
                    <td width="36%" scope="col" align="right">
                  ...
                  <tr>
                    ...
                    <td><input id="in" type="date" name="dat" />
                      <font color="red">*</font>
                    </td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td><input id="in" type="time" name="tem" />
                      <font color="red">*</font>
                    </td>
                    <td>&nbsp;</td>
                  </tr>
                  <tr>
                    ...
                    <td><textarea id="in" name="des" cols="22" rows="5"></textarea>
                      <font color="red">*</font>
                    </td>
                    <td>&nbsp;</td>
                  </tr>
