...
?>
    ...
    <br />
    <div class="glass" style="background: transparent;border: 1px solid Black; margin-left: 33%; alignment-adjust: central; width: 35%; border: 1px solid Black">
