...
?>
    ...
    <div>
      ...
      <body>
        ...
        <table class="glass" width="100%" border="0" cellspacing="01" cellpadding="01">
          <tr>
        ...
        <form method="post" action="skill.php">
          <div class="glass" style="background-color: transparent;border: 1px solid Black; margin-left: 33%; alignment-adjust: central; width: 35%; border: 1px solid black;">
            <table align="center" cellspacing="05" cellpadding="05">
              ...
              <tr>
                <td align="center" colspan="3">
                  <input type="submit" id="bt" name="view" value="View" />
                </td>
                <td>&nbsp;</td>
              </tr>
            </table>
          ...
          <br />
          <div class="glass" style="background-color: transparent;border: 1px solid Black; margin-left: 33%; alignment-adjust: central; width: 35%">
