...
?>
    ...
    <div>
      ...
      <body>
        ...
        <table class="glass" width="100%" border="0px" cellspacing="01" cellpadding="01">
          <tr >
        ...
        <form method="post" action="st.php">
          <div class="glass" style="background: transparent;border: 1px solid Black; margin-left: 25%; alignment-adjust: central; width: 50%">
