        ...
        <div>
            ...
            <body>
                ...
                <form method="post" action="mail.php">
                    <div class="glass" style="border: 1px solid black;">
                        ...
                        <table width="40%" cellpadding="0" cellspacing="0" align="center">
                            <tr>
                                ...
                                <td colspan="3" align="center">
                                    <br /><br />
                                    <div class="glass" style="border: 1px solid black" style="background-color: beige; width: 40%; margin-left: 5%; border: black;">
                                        <br /><br />
