            ...
            ?>
                ...
                <div>
                    ...
                    <body>
                        ...
                        <div style="background-color: transparent; width: 70%; margin-left: 15%; margin-top: 0px; ">
                            <br /><br /><br />
                            <form method="post" action="project.php" enctype="multipart/form-data">
                                ...
                                <table width="100%" border="0" cellspacing="05" cellpadding="05">
                                    ...
                                    <tr>
                                        <td>&nbsp;</td>
                                        <td align="center">
                                            <div class="glass" style="border: 1px solid black"><br />
                                                <h3>Project Proposal</h3><br /><input type="file" name="ppf" /><br /><br /><input type="submit" name="bppf" value="upload" /><br /><br />
                                            </div>
                                        </td>
                                        <td align="center">
                                            <div class="glass" style="border: 1px solid black"><br />
                                                <h3>Project Specification</h3><br /><input type="file" name="psf" /><br /><br /><input type="submit" name="bpsf" value="upload" /><br /><br />
                                            </div>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
