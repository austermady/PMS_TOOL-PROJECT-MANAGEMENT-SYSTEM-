            ...
            ?>
                ...
                <div>
                    ...
                    <body>
                        ...
                        <div style="background-color: transparent;#D2691E; width: 50%; margin-left: 25%; margin-top: 0px; ">
                            <br /><br />
                            <form method="post" action="skill.php">
                                <table class="glass" style="border: 1px solid black;" align="center" width="30%">
                                    <tr>
                            ...
                            <form method="post" action="skill.php">
                                <div class="glass" style="background-color: transparent; width: 60%; margin-left: 20%;border: 1px solid black">
